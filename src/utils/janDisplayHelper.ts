...
const JAN_EXCEPTION_MAP: { [key: string]: string } = {
  '4901301416292': 'せっけん', // B0BXVLPQSP 花王 メンズビオレ 顔もふけるボディシート 清潔感のある石けんの香り 28枚×6
  '000000000JA033': 'クール', // B0BXVYK3C1 花王 メンズビオレ 顔もふけるボディシート クールタイプ 28枚×6
  ...
  '4571607691855': 'ソラミー', // B0DWN14LWN SOLAMY ソラミー UV プロテクト ヘアオイル 50ml
